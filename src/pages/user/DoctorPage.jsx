...
import { Search, Filter, DoorClosed, XIcon } from "lucide-react"
  ...
  useEffect(() => {
    const checkFooter = () => {
      ...
      if (footer && div) {
        ...
        setIsNearFooter(footerRect.top < divRect.bottom);
      }
    };
  ...
  return (
    <main className="container mx-auto px-4 py-8">
      ...
      <div className="flex flex-col md:flex-row gap-6">
        <div className="relative md:w-1/5 overflow-auto">
          ...
          {isFilterOpen && (
            <div className="fixed inset-0 transition duration-300 bg-opacity-50 z-50 flex justify-end">
              <div className="w-64 bg-white shadow-lg h-full p-4">
                <button className="mb-4 font-bold" onClick={() => setIsFilterOpen(false)} >
                  <XIcon />
                </button>
        ...
        <div className="w-full md:w-3/4 shadow-md p-1 rounded md:h-screen transition duration-300 overflow-y-scroll">
          <DoctorList />
        </div>
      </div>
    </main>
