            ...
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8">
              {[1, 2, 3, 4, 5, 6].map((item) => (
                <div key={item} className="flex items-center justify-center p-4">
                  <div className="w-full h-12 bg-gray-200 rounded-xl flex items-center cursor-pointer justify-center">
                    <img src={insuranceImg} alt="insurance" className="rounded-xl object-cover border" />
                  </div>
                </div>
              ))}
            </div>
